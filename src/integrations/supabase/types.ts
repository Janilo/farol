// GERADO por `supabase gen types typescript` a partir do projeto do Farol.
// NÃO editar à mão — regerar quando uma migration mudar o schema.
//
// Regerado em 28/jul/2026, na Fase 3. O arquivo anterior ainda descrevia o
// schema do Cascata — business_units, customers, line_inputs, waterfall_lines,
